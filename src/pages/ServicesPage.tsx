    ...
    return (
        <div className="min-h-screen bg-white font-sans p-8">
            ...
            <div className="max-w-4xl mx-auto">
                <h1 className="text-5xl font-black mb-8 text-[#202124]">Our Diagnostic Services</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {services.map((service, idx) => (
                        <div key={idx} className="p-6 border border-google-border rounded-2xl shadow-sm hover:shadow-lg transition-all flex items-center gap-4">
